...
Original file is located at
    https://colab.research.google.com/drive/1-brRZYaUKAhAjV8zXvJa0GcEKplh3Uwa
"""
...
estimator_gpu = BackendEstimatorV2(backend=Aer.get_backend(name='statevector_simulator', backend_options={"device": "GPU"}))
# estimator = Estimator(
#     backend_options={
#         "method": "statevector",
#         "device": "GPU"
...
# asd = Aer.get_backend(name='statevector_simulator', backend_options={"device": "GPU",
...
def create_qnn():
    ...
    # transpile the simulator
    qc = transpile(qc, simulator_gpu.backend)
...
a, (b, c)=enumerate(train_loader).__next__()
...
optimizer = LBFGS(model4.parameters(), lr=0.001)
loss_func = NLLLoss()
...
for epoch in range(epochs):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        print(".", end="")
        print(f"{batch_idx}/{number_of_batches}")
    print("")
